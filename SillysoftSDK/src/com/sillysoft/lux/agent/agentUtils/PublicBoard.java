...
public class PublicBoard extends Board {
	...
	public PublicBoard(Country[] countries) {
	...
	public int attack( int countryCodeAttacker, int countryCodeDefender, boolean attackTillDead) {
		return super.attack(countryCodeAttacker, countryCodeDefender, attackTillDead);
	}
	...
	/** Get the location of saved maps. There might be subfolders in here. */
